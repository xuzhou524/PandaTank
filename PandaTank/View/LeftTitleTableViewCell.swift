...
class LeftTitleTableViewCell: UITableViewCell {
    ...
    func setup()->Void{
        ...
        self.nodeImageView.tintColor = UIColor.black
        ...
        self.rightImageView.tintColor = UIColor.black
...
class LeftsTitleTableViewCell: UITableViewCell {
    ...
    func setup()->Void{
        ...
        self.nodeNameLabel.snp.makeConstraints{ (make) -> Void in
            make.right.equalTo(self.panel.snp.right).offset(-15)
            make.centerY.equalTo(self.panel)
        }
